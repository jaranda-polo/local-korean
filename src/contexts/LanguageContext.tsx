...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.profile": "Profile",
    "nav.search": "Search", // Keeping for backward compatibility
    ...
    // Discover Page (formerly Search)
    "discover.title": "Discover",
    "discover.placeholder": "Search for teachers, content, topics",
    "discover.recentSearches": "Recent Searches",
    "discover.clearAll": "Clear All",
    "discover.categories": "Categories",
    "discover.all": "All",
    "discover.teachers": "Teachers",
    "discover.content": "Content",
    "discover.popularSearches": "Popular Searches",
    "discover.publicTransport": "Using Public Transport",
    "discover.hospitalVisit": "Hospital Visit",
    "discover.orderingRestaurant": "Ordering at Restaurants",
    "discover.cafeConversation": "Cafe Conversation",
    "discover.topikPrep": "TOPIK Preparation",
    "discover.recommended": "Recommended Exploration",
    "discover.seoulGuide": "Seoul Living Guide",
    "discover.kpopKorean": "Korean for K-Pop Fans",
    "discover.cultureEtiquette": "Korean Culture and Etiquette",
    "discover.popularTeachers": "Popular Teachers",
    "discover.seeAll": "See All",
    "discover.helpfulExpressions": "Helpful Expressions",
    "discover.conversationTopics": "Conversation Topics",
    "discover.requestClass": "Request Class",
    "discover.viewProfile": "View Profile",
    "discover.trending": "Trending Now",
    "discover.dailyTips": "Daily Korean Tips",
    "discover.expressionOfTheDay": "Expression of the Day",
  ...
  ko: {
    ...
    "nav.messages": "메시지",
    "nav.profile": "프로필",
    "nav.search": "검색", // Keeping for backward compatibility
    ...
    // Discover Page (formerly Search)
    "discover.title": "탐색",
    "discover.placeholder": "선생님, 콘텐츠, 주제 검색",
    "discover.recentSearches": "최근 검색어",
    "discover.clearAll": "전체 삭제",
    "discover.categories": "카테고리",
    "discover.all": "전체",
    "discover.teachers": "선생님",
    "discover.content": "콘텐츠",
    "discover.popularSearches": "인기 검색어",
    "discover.publicTransport": "대중교통 이용하기",
    "discover.hospitalVisit": "병원 방문",
    "discover.orderingRestaurant": "음식점에서 주문하기",
    "discover.cafeConversation": "카페 회화",
    "discover.topikPrep": "TOPIK 준비",
    "discover.recommended": "추천 탐색",
    "discover.seoulGuide": "서울 생활 정착 가이드",
    "discover.kpopKorean": "K-Pop 팬을 위한 한국어",
    "discover.cultureEtiquette": "한국 문화와 예절",
    "discover.popularTeachers": "인기 선생님",
    "discover.seeAll": "전체 보기",
    "discover.helpfulExpressions": "유용한 표현",
    "discover.conversationTopics": "대화 주제",
    "discover.requestClass": "수업 요청",
    "discover.viewProfile": "프로필 보기",
    "discover.trending": "지금 인기 있는",
    "discover.dailyTips": "오늘의 한국어 팁",
    "discover.expressionOfTheDay": "오늘의 표현",
  ...
  ja: {
    ...
    "nav.messages": "メッセージ",
    "nav.profile": "プロフィール",
    "nav.search": "検索", // Keeping for backward compatibility
    ...
    // Discover Page (formerly Search)
    "discover.title": "発見",
    "discover.placeholder": "講師、コンテンツ、トピックを検索",
    "discover.recentSearches": "最近の検索",
    "discover.clearAll": "すべて消去",
    "discover.categories": "カテゴリー",
    "discover.all": "すべて",
    "discover.teachers": "講師",
    "discover.content": "コンテンツ",
    "discover.popularSearches": "人気の検索",
    "discover.publicTransport": "公共交通機関の利用",
    "discover.hospitalVisit": "病院訪問",
    "discover.orderingRestaurant": "レストランでの注文",
    "discover.cafeConversation": "カフェでの会話",
    "discover.topikPrep": "TOPIK準備",
    "discover.recommended": "おすすめ探索",
    "discover.seoulGuide": "ソウル生活ガイド",
    "discover.kpopKorean": "K-Popファンのための韓国語",
    "discover.cultureEtiquette": "韓国の文化とマナー",
    "discover.popularTeachers": "人気の講師",
    "discover.seeAll": "すべて見る",
    "discover.helpfulExpressions": "役立つ表現",
    "discover.conversationTopics": "会話トピック",
    "discover.requestClass": "クラスをリクエスト",
    "discover.viewProfile": "プロフィールを見る",
    "discover.trending": "トレンド",
    "discover.dailyTips": "今日の韓国語のヒント",
    "discover.expressionOfTheDay": "今日の表現",
